    ...
    return (
        <div className={`bg-white duration-500 fixed bottom-5 left-[4vw] ${fullWidth ? 'w-[92vw]' : 'w-[60vw]'}`}>
            <div className="flex h-full items-center relative ">
                ...
                <div className={`h-[20px] w-[20px] border-secondary relative left-4    ${(sliderValue == 0) ? " pointer-events-none " : "  border-r-2 bg-white"}`}>
                    <div className="absolute -bottom-8 text-[#bfbfbf]">1980</div>
                </div>
                ...
                <div className={`h-[20px] w-[20px] border-secondary relative right-4   ${(sliderValue == 100) ? " pointer-events-none " : "  border-l-2 bg-white"}`}>
                    <div className="absolute -bottom-8 right-0  text-[#bfbfbf]">2080</div>
                </div>
            </div>
